  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-stone-50 to-white">
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-white/95 backdrop-blur-md shadow-lg' : 'bg-transparent'}`}>
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <h1 className="text-2xl font-bold text-amber-700">사랑채</h1>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1587061949409-02df41d5e562?w=1920')] bg-cover bg-center"></div>
        
        <div className="relative z-20 text-center text-white px-4 max-w-4xl mx-auto">
          <h2 className="text-5xl md:text-7xl font-bold mb-6 animate-fade-in">
            김포의 특별한 휴식공간
            <span className="block text-3xl md:text-5xl mt-4 text-amber-300">사랑채</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-amber-600 text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-amber-700 transform hover:scale-105 transition-all shadow-xl"
            >
              지금 예약하기
            </a>
            <button
              onClick={() => scrollToSection('intro')}
              className="bg-white/20 backdrop-blur text-white border-2 border-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-white hover:text-amber-700 transform hover:scale-105 transition-all"
            >
              더 알아보기
            </button>
          </div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-amber-100 to-orange-50 p-8 rounded-3xl">
      ...
      <section id="features" className="py-20 px-4 bg-gradient-to-b from-amber-50 to-white">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">완벽한 휴식과 즐거움을 위한 모든 것</p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden hover:transform hover:scale-105 transition-all">
      ...
      <section id="pricing" className="py-20 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-16">
            ...
            <div className="w-24 h-1 bg-amber-600 mx-auto mb-4"></div>
            <p className="text-xl text-gray-600">합리적인 가격으로 특별한 추억을 만들어보세요</p>
          </div>

          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-amber-500 to-orange-600 p-8 rounded-3xl text-white shadow-2xl hover:transform hover:scale-105 transition-all">
            ...
            <div className="bg-white border-2 border-gray-200 p-8 rounded-3xl shadow-xl hover:transform hover:scale-105 transition-all">
          ...
          <div className="mt-12 bg-gradient-to-r from-amber-50 to-orange-50 p-8 rounded-2xl">
      ...
      <section id="location" className="py-20 px-4 bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <div className="mt-8">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block w-full bg-gradient-to-r from-amber-600 to-orange-600 text-white text-center py-4 rounded-xl font-semibold hover:from-amber-700 hover:to-orange-700 transition-all shadow-lg"
                >
                  네이버에서 예약하기
                </a>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden h-96 md:h-auto">
              <iframe
        ...
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-white text-amber-700 px-8 py-4 rounded-full text-lg font-bold hover:bg-gray-100 transform hover:scale-105 transition-all shadow-xl"
            >
              네이버 예약하기
            </a>
            <a
              href="tel:0507-1364-7231"
              className="bg-amber-700 text-white px-8 py-4 rounded-full text-lg font-bold hover:bg-amber-800 transform hover:scale-105 transition-all shadow-xl border-2 border-white/30"
            >
              📞 전화 문의하기
            </a>
          </div>
